...
/* themes/myproject/templates/block/block--myproject-branding.html.twig */
class __TwigTemplate_c192577e0f1113c8c6f874b13d6b7aa040c439368df266f0efaed37dc9eb57aa extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("block.html.twig", "themes/myproject/templates/block/block--myproject-branding.html.twig", 1);
...
";
    ...
    {
        return "themes/myproject/templates/block/block--myproject-branding.html.twig";
    }
...
{% block content %}
  {% if site_logo %}
    <a href=\"{{ path('<front>') }}\" rel=\"home\">
      <img src=\"{{ site_logo }}\" alt=\"{{ 'Home'|t }}\" class=\"astudio__site-logo\" />
    </a>
  {% endif %}
  {% if site_name %}
  ...
  {{ site_slogan }}
{% endblock %}
", "themes/myproject/templates/block/block--myproject-branding.html.twig", "/var/www/html/web/themes/myproject/templates/block/block--myproject-branding.html.twig");
    }
