...
/* themes/myproject/templates/field/field--paragraph--our-client.html.twig */
class __TwigTemplate_f009799decc24ef420893bfe6ad9edd7d8d2246eb55235b6d507da4ca8c75427 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 49
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "ourclient-images"], "method", false, false, true, 49), 49, $this->source), "html", null, true);
                echo ">
      ";
                // line 50
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 51
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 51), "addClass", [0 => "ourclient-img"], "method", false, false, true, 51), 51, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/myproject/templates/field/field--paragraph--our-client.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass('ourclient-images') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('ourclient-img') }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
...
{% endif %}
", "themes/myproject/templates/field/field--paragraph--our-client.html.twig", "/var/www/html/web/themes/myproject/templates/field/field--paragraph--our-client.html.twig");
    }
