...
<div class='astudio__business-card'>
  <div class='astudio__business-card-img'>
    <div class='astudio__business-card-img-img1'>";
        // line 45
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_business_card_image", [], "any", false, false, true, 45), 0, [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
        echo "</div>
  </div>
  <h2>";
        // line 47
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_business_card_title", [], "any", false, false, true, 47), 0, [], "any", false, false, true, 47), 47, $this->source), "html", null, true);
        echo "</h2>
  <p>";
        // line 48
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_business_card_body", [], "any", false, false, true, 48), 0, [], "any", false, false, true, 48), 48, $this->source), "html", null, true);
        echo "</p>
</div>
...
";
    ...
    {
        return array (  57 => 48,  53 => 47,  48 => 45,  42 => 42,  39 => 41,);
    }
