...
class __TwigTemplate_d209b788e7eb8efa518158ce5f7f3854af3c78b80c7ea8f4bdf1f21f9d251e52 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 36
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "footer__container"], "method", false, false, true, 36), 36, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 38
                    echo "      <ul class='footer__container-ul'>
    ";
                }
                // line 40
                echo "    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 41
                    echo "      <li";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 41), "addClass", [0 => ("footer__container-li menu-level-" . $this->sandbox->ensureToStringAllowed(($context["menu_level"] ?? null), 41, $this->source))], "method", false, false, true, 41), 41, $this->source), "html", null, true);
                    echo " >
        ";
                    // line 42
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('footer__container') }}>
    {% else %}
      <ul class='footer__container-ul'>
    {% endif %}
    {% for item in items %}
      <li{{ item.attributes.addClass('footer__container-li menu-level-' ~ menu_level) }} >
