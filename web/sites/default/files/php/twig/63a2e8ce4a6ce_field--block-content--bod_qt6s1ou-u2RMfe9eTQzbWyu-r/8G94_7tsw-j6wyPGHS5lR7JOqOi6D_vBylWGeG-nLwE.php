...
/* themes/myproject/templates/field/field--block-content--body--footer-secondary.html.twig */
class __TwigTemplate_a6082e62274c26f949b0f19ee14a915d31c71b9bfc3e820e546e18b2158adfa4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 49
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "footer__secondary"], "method", false, false, true, 49), 49, $this->source), "html", null, true);
                echo ">
      ";
                // line 50
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 51
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 51), "addClass", [0 => "footer__i"], "method", false, false, true, 51), 51, $this->source), "html", null, true);
                    echo ">";
  ...
  ";
    ...
    ";
            ...
            // line 60
            echo "  <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "foo"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
            echo ">
    <div";
            // line 61
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 66
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 66), "addClass", [0 => "foo1"], "method", false, false, true, 66), 66, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/myproject/templates/field/field--block-content--body--footer-secondary.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass('footer__secondary') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('footer__i') }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
  ...
  {% endif %}
{% else %}
  <div{{ attributes.addClass('foo') }}>
    <div{{ title_attributes.addClass(title_classes) }}>{{ label }}</div>
    {% if multiple %}
      <div>
    {% endif %}
    {% for item in items %}
      <div{{ item.attributes.addClass('foo1') }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/myproject/templates/field/field--block-content--body--footer-secondary.html.twig", "/var/www/html/web/themes/myproject/templates/field/field--block-content--body--footer-secondary.html.twig");
    }
