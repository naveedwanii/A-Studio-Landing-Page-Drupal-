...
";
        // line 60
        echo "  <div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "img"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
        echo ">
    ";
        // line 61
...
";
   ...
   <h2>";
        // line 65
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["paragraph"] ?? null), "field_title", [], "any", false, false, true, 65), "value", [], "any", false, false, true, 65), 65, $this->source), "html", null, true);
        echo "</h2>
   <p> ";
        // line 66
   ...
   <div class='astudio__business-dotgroupImg'></div>
    ...
    <div class='astudio__business-cards'>
      ";
        // line 70
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 70, $this->source), "field_title", "field_body"), "html", null, true);
        echo "
    </div>
  </div>
    ";
    ...
    {
        return array (  76 => 70,  69 => 66,  65 => 65,  60 => 62,  56 => 61,  51 => 74,  49 => 61,  44 => 60,  40 => 50,);
    }
...
", "themes/myproject/templates/paragraphs/paragraph--info-cards.html.twig", "/var/www/html/web/themes/myproject/templates/paragraphs/paragraph--info-cards.html.twig");
    ...
    {
        static $tags = array("block" => 61);
        static $filters = array("escape" => 60, "without" => 70);
