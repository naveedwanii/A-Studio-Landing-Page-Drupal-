...
class __TwigTemplate_61a6f03fb95b0ce807d0785aeffb8a59ccdc81c1aa7fe98105aa9dbb64135092 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 34
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "menu__link"], "method", false, false, true, 34), 34, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 36
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('menu__link') }}>
    {% else %}
      <ul class=\"menu\">
    {% endif %}
    {% for item in items %}
      ...
      %}
      <li{{ item.attributes.addClass('menu__link-li') }}>
        {{ link(item.title, item.url, item.attributes.addClass('menu__link-a')) }}
        {% if item.below %}
